    ...
    <div class="wrapper"> 
        ...
        <header class="main-header">
            ...
            <a href="#" class="logo">
                ...
                <span class="logo-lg"><IMG SRC="../../assests/images/logo.JPG" WIDTH=180 HEIGHT=100%></span>
            </a>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <p>
                                    ...
                                    echo $nombres . " " . $apellido;?>
                                        ...
                                        <small>Digitalización de Procesos</small>
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    <li class="header">MENÚ DE OPCIONES</li>
                        <?php include '../../includes/menu_header/menu.php'; ?>
                </ul>
