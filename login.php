...
<html>
    <head>
        ...
        <title>Portal de Gestión de Procesos</title>
    ...
    <body class="hold-transition login-page" STYLE="background-color:#1E3770">
        ...
        <header>
            <div class="container">
                <figure class="inventariapp-logo-container pull-left">
                    <a href="https://pichincha.pe"><img class="inventariapp-logo img-responsive" src="assests/images/logo.JPG" width="200" height="200" ></a>
                </figure>
            </div>
        </header>
        <!-- fin cabecera -->
        ...
        <div class="login-box">
            <div  class="login-logo">
                <font color="white" style="font-family:sans-serif"><b>Portal de Procesos</b></font>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                
                <p class="login-box-msg"><font size =" 5" style="font-family:sans-serif"><u><b> Iniciar sesión </b></u></font></p>
